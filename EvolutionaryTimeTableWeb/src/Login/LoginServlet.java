...
//    private final String UsersAndProblems_URL = "pagesAndProblems/usersAndProblems.html";
//    private final String SIGN_UP_URL = "index.html";
//    private final String LOGIN_ERROR_URL = "/ErrorLogin/login_attempt_after_error.jsp";  // must start with '/' since will be used in request dispatcher...
//    /**
...
//            String usernameFromParameter = request.getParameter(MyConstants.USERNAME);
...
//                usernameFromParameter = usernameFromParameter.trim(); /// trim -> delete white spaces in the string inside the text field
//
//                /*
...
//                        request.setAttribute(MyConstants.USER_NAME_ERROR, errorMessage);
...
//                        //create a new one
//                        request.getSession(true).setAttribute(MyConstants.USERNAME, usernameFromParameter);
//
//                        //redirect the request to the chat room - in order to actually change the URL
////                        System.out.println("On login, request URI is: " + request.getRequestURI());
//                        response.sendRedirect(UsersAndProblems_URL);
//                    }
//                }
//            }
//        } else {
...
public class LoginServlet extends HttpServlet {
    ...
    private final String UsersAndProblems_URL = "usersAndProblems/usersAndProblems.html";
   private final String SIGN_UP_URL = "index.html";
//    private final String LOGIN_ERROR_URL = "/ErrorLogin/login_attempt_after_error.jsp";   // must start with '/' since will be used in request dispatcher...
    /**
     * Processes requests for both HTTP <code>GET</code> and <code>POST</code>
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) { //user is not logged in yet
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                response.getOutputStream().println("You must enter a name to sign up!");
//                response.getOutputStream().println(SIGN_UP_URL);
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        response.getOutputStream().println(UsersAndProblems_URL);
                    }
                }
            }
        } else {
